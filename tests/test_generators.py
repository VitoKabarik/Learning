...
from homework.generators import card_number_generator, filter_by_currency, transaction_descriptions


def test_filter_by_currency(list_for_tests: list) -> None:
    """Тестирует функцию, выдающую по запросу транзакции с указанной валютой."""
...
def test_transaction_descriptions(list_for_tests: list) -> None:
    """Тестирует функцию, описывающую по запросу тип транзакций в предложенном списке."""
...
@pytest.mark.parametrize(
    "first_num, last_num, expected_list",
    [
        (
            6,
            1,
...
def test_card_number_generator(first_num: int, last_num: int, expected_list: list) -> None:
    """Тестирует функцию, генерирующую номера карт в указанном интервале."""
